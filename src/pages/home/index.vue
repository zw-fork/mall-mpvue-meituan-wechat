    ...
    <div class="content">
      <div class="header-c">
        <div class="header-l">
          ...
          <i @click="updateAddress" class="icon iconfont icondingwei" :style="{color: '#434343', 'font-size': 34 + 'rpx'}" style="position:absolute;right:30rpx;"></i>
        </div>
      </div>
      <div class="category-list">
        <scroll-view class="item-list" :scroll-y="true">
          <div class="item" v-for="(item, index) in shopList" :key="index" @click="shoppingCartClick(item)">
            <div class="item-l">
          ...
          <div v-if="!shopList || shopList.length < 1" class="item" style="display: flex;justify-content: center;align-items: center;top:40%">当前地址无商铺信息!</div>
        </scroll-view>
      </div>
    </div>
  </div>
