<template>
  <div class="container">
    ...
    <div class="b-mid">
      <div class="mid-l">
        <span>商品分类:</span>
        <i @click="createCategory" class="icon my_iconfont iconplus-circle"></i>
      </div>
...
export default {
  ...
  onLoad(options) {
    ...
    getFetch(
      ...
      if (options.id) {
        getFetch(
          ...
          if (response.result.list.length > 0) {
            // var categoryName = this.goods.categoryName
            // var categoryId = this.goods.categoryId
            this.goods = response.result.list[0];
            // this.goods.categoryName = categoryName
      ...
      if (!this.goods.categoryName && list.length>0) {
        this.goods.categoryId = list[0].categoryId;
        this.goods.categoryName = list[0].name;
      } else {
        this.goods.categoryId = categoryId;
        this.goods.categoryName = categoryName;
      }
