    ...
    <div class="container" @click="update" @mousedown="update" @scroll="update">
      <div class="header-c">
        ...
        <div class="cate-c" v-if="userInfo.role == 3">
          ...
          <span class="c-m" :style="{'font-weight': pageIndex === 1 ? 'bold;' : null}" style="text-align:center;width:33%;" @click="updateGoodsList(1)">店主</span>
          <span class="c-m" :style="{'font-weight': pageIndex === 2 ? 'bold;' : null}" style="text-align:center;width:33%;" @click="updateGoodsList(2)">店员</span>
        </div>
      </div>
          ...
          <div class="item-list" v-for="(item, index) in list.datas" :key="index">
            <div class="item">
              ...
              <div class="item-r">
                ...
                <div class="r-t" v-if="(item.role == 1 && userInfo.role== 2 ) || (item.id == userInfo.id && userInfo.role== 1) || userInfo.role== 3">
                  <div class="add-item">
