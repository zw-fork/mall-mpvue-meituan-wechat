      ...
      <div class="delivery">
        <div class="address-c">
          ...
          <div v-else-if="orderDetail.refundStatus==1">
            ...
            <p
              class="address-info1"
              v-if="orderDetail.refundExplain"
            >退款原因：{{orderDetail.refundExplain}}</p>
          </div>
          ...
          <span
            class="address-info"
            v-else-if="orderDetail.deliveryStatus==1"
          >已支付，等待商家配送</span>
          <span
            class="address-info"
            v-else-if="orderDetail.deliveryStatus==2"
          >配送中</span>
          <span
            class="address-info"
            v-else-if="orderDetail.deliveryStatus==3"
          >已完成</span>
          <span
            class="address-info"
        ...
        <div class="bottom-a">
          <div
            ...
            @click="updateStatus(null, null, 0)"
          >
            <span>取消退款</span>
          </div>
          <div
          ...
          <div class="item-r">
            ...
            <div class="r-t">
              ...
              <span
                ...
                v-if="item.refundTime && orderDetail.refundFee && orderDetail.refundStatus!=2 && orderDetail.refundStatus!=3"
              >已退款</span>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    refund(itemId) {
      var urlPath =
        "/pages/subsidy/refund/main?orderId=" + this.orderDetail.number;
      if (itemId) {
