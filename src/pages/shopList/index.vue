      ...
      <div class="list-c">
        <scroll-view class="list-r" :scroll-y="true" :scroll-top="scrollTop" @scrolltolower="lower">
          <div class="item-list" v-for="(item, index) in list.datas" :key="index">
            <div class="item">
              <div class="item-l">
                <img :src="path + item.pic_url">
              </div>
              <div class="item-r">
                <span class="sub-title">店铺名称：{{item.shopName}}</span>
                <span class="sub-title">店铺地址：{{item.wxAddress.name}}</span>
                <span class="sub-title">店主：{{item.realname}}</span>
                <span class="sub-title">电话号码：{{item.tel}}</span>
                <span class="sub-title">状态：{{item.status}}</span>
              </div>
            </div>
          </div>
        </scroll-view>
...
export default {
  ...
  methods: {
    ...
    getGoods() {
      ...
      getFetch("/shop/list", data, false).then(response => {
