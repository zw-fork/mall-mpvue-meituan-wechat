  ...
  methods: {
    ...
    orderClick() {
      if (this.shopInfo) {
        ...
        if (
          (this.shopInfo.status != 1 && this.shopInfo.status != 2) ||
          price < this.shopInfo.min_price
        )
          return;
    ...
    goHome() {
      if (
        !this.userInfo.addressModel ||
        this.userInfo.addressModel.communityId !=
          this.shopInfo.addressModel.communityId
      ) {
