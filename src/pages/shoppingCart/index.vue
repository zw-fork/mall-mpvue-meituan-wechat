<template>
  <div class="container" v-if="!shopId || shopId == shopInfo.shopId">
    ...
    <div class="list-c" v-if="pageIndex === 0">
      ...
      <scroll-view class="list-r" :scroll-y="true" @scrolltolower="lower" :scroll-top="scrollTop">
        <div class="section">
    ...
    methods: {
      ...
      orderClick() {
        if (this.shopInfo) {
          ...
          if ((this.shopInfo.status != 1 && this.shopInfo.status != 2) || price < this.shopInfo.min_price) return;
